    ...
    <BrowserRouter>
      <Routes>
        <Route element={<Layout Layout={accessToken ? true : false} />}>
          ...
          <Route
            path="/Announcement"
            element={accessToken ? <Announcement /> : <Login />}
          />
          <Route
            path="/AnnounceWrite"
            element={accessToken ? <AnnounceWrite /> : <Login />}
          />
          <Route
            path="/AnnounceEdit/:id"
            element={accessToken ? <AnnounceEdit /> : <Login />}
          />
          <Route
            path="/AnnounceRead/:id"
          ...
          <Route
            path="/StudentList"
            element={accessToken ? <StudentList /> : <Login />}
          />
          <Route
            path="/EditProfile"
            element={accessToken ? <EditProfile /> : <Login />}
          />
          <Route
            path="/MyProfile"
            element={accessToken ? <MyProfile /> : <Login />}
          />
        </Route>
        <Route path="/Login" element={!accessToken ? <Login /> : <Main />} />
        <Route
          path="/SignUp"
          element={!accessToken ? <Register /> : <Main />}
        />
        <Route
          path="/FindPassword"
          element={!accessToken ? <FindPassword /> : <Login />}
        />
      </Routes>
    </BrowserRouter>
  );
